...
interface SimpleMerkleDistributerInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleMerkleDistributer extends BaseContract {
  ...
  interface: SimpleMerkleDistributerInterface;
